...
export const allGachaItems: GachaItem[] = [
  ...
  { id: "gacha_king", type: "avatar", name: "アバター「キング」", icon: "/kanji-quest/images/avatars/avatar_knight.jpg", rarity: "神レア", weight: 20 },
  ...
  { id: "gacha_ancient_dragon", type: "avatar", name: "アバター「エンシェントドラゴン」", icon: "/kanji-quest/images/avatars/avatar_dragon.jpg", rarity: "超激レア", weight: 326 },
  { id: "gacha_pegasus", type: "avatar", name: "アバター「ペガサス」", icon: "/kanji-quest/images/bosses/cute_griffin.jpg", rarity: "超激レア", weight: 326 },
  { id: "gacha_light_fairy", type: "avatar", name: "アバター「光の妖精」", icon: "/kanji-quest/images/bosses/cute_slime.jpg", rarity: "超激レア", weight: 326 },
  { id: "gacha_super_robot", type: "avatar", name: "アバター「スーパーロボット」", icon: "/kanji-quest/images/avatars/avatar_cyborg.jpg", rarity: "超激レア", weight: 326 },
  { id: "gacha_alien_boss", type: "avatar", name: "アバター「宇宙人ボス」", icon: "/kanji-quest/images/bosses/boss_golem.jpg", rarity: "超激レア", weight: 326 },
  ...
  { id: "gacha_trex", type: "avatar", name: "アバター「T-REX」", icon: "/kanji-quest/images/bosses/boss_trex.jpg", rarity: "激レア", weight: 400 },
  { id: "gacha_griffin", type: "avatar", name: "アバター「グリフォン」", icon: "/kanji-quest/images/bosses/boss_griffin.jpg", rarity: "激レア", weight: 400 },
  { id: "gacha_megalodon", type: "avatar", name: "アバター「メガロドン」", icon: "/kanji-quest/images/bosses/boss_kraken.jpg", rarity: "激レア", weight: 400 },
  { id: "gacha_vampire", type: "avatar", name: "アバター「吸血鬼」", icon: "/kanji-quest/images/bosses/boss_bat.jpg", rarity: "激レア", weight: 400 },
  { id: "gacha_great_wizard", type: "avatar", name: "アバター「大魔法使い」", icon: "/kanji-quest/images/bosses/boss_ogre.jpg", rarity: "激レア", weight: 400 },
  { id: "gacha_master_ninja", type: "avatar", name: "アバター「マスター忍者」", icon: "/kanji-quest/images/bosses/boss_wolf.jpg", rarity: "激レア", weight: 400 },
  { id: "gacha_white_tiger", type: "avatar", name: "アバター「ホワイトタイガー」", icon: "/kanji-quest/images/bosses/boss_dragon.jpg", rarity: "激レア", weight: 400 },
  { id: "gacha_fenrir", type: "avatar", name: "アバター「フェンリル」", icon: "/kanji-quest/images/bosses/boss_wolf.jpg", rarity: "激レア", weight: 400 },
  ...
  { id: "gacha_dog", type: "avatar", name: "アバター「犬」", icon: "/kanji-quest/images/bosses/cute_wolf.jpg", rarity: "レア", weight: 1000 },
  { id: "gacha_cat", type: "avatar", name: "アバター「猫」", icon: "/kanji-quest/images/bosses/cute_bat.jpg", rarity: "レア", weight: 1000 },
  { id: "gacha_fox", type: "avatar", name: "アバター「キツネ」", icon: "/kanji-quest/images/bosses/cute_dragon.jpg", rarity: "レア", weight: 1000 },
  { id: "gacha_bear", type: "avatar", name: "アバター「クマ」", icon: "/kanji-quest/images/bosses/cute_ogre.jpg", rarity: "レア", weight: 1000 },
  { id: "gacha_panda", type: "avatar", name: "アバター「パンダ」", icon: "/kanji-quest/images/bosses/cute_scorpion.jpg", rarity: "レア", weight: 1000 },
  { id: "gacha_lion", type: "avatar", name: "アバター「ライオン」", icon: "/kanji-quest/images/bosses/cute_trex.jpg", rarity: "レア", weight: 1000 },
  { id: "gacha_frog", type: "avatar", name: "アバター「カエル」", icon: "/kanji-quest/images/bosses/cute_slime.jpg", rarity: "レア", weight: 1000 },
  { id: "gacha_owl", type: "avatar", name: "アバター「フクロウ」", icon: "/kanji-quest/images/bosses/cute_griffin.jpg", rarity: "レア", weight: 1000 },
  { id: "gacha_ghost", type: "avatar", name: "アバター「おばけ」", icon: "/kanji-quest/images/bosses/boss_bat.jpg", rarity: "レア", weight: 1000 },
  { id: "gacha_skull", type: "avatar", name: "アバター「ドクロ」", icon: "/kanji-quest/images/bosses/boss_scorpion.jpg", rarity: "レア", weight: 1000 },
