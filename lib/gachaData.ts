...
export const allRichGachaItems: GachaItem[] = [
  ...
  // --- かわいい枠 (Cute) ---
  { id: "rich_princess", type: "avatar", name: "アバター「プリンセス」", icon: "/kanji-quest/avatars/cute_princess_v3.png", rarity: "神レア", weight: 20 },
  ...
  { id: "rich_mermaid", type: "avatar", name: "アバター「マーメイド」", icon: "/kanji-quest/avatars/cute_mermaid_v3.png", rarity: "激レア", weight: 1000 },
];
