...
export const allGachaItems: GachaItem[] = [
  ...
  { id: "🐉", type: "avatar", name: "アバター「エンシェントドラゴン」", icon: "🐉", rarity: "超激レア", weight: 326 },
  { id: "🦄", type: "avatar", name: "アバター「ペガサス」", icon: "🦄", rarity: "超激レア", weight: 326 },
  ...
  { id: "🦖", type: "avatar", name: "アバター「T-REX」", icon: "🦖", rarity: "激レア", weight: 400 },
  { id: "🦅", type: "avatar", name: "アバター「グリフォン」", icon: "🦅", rarity: "激レア", weight: 400 },
  { id: "🦈", type: "avatar", name: "アバター「メガロドン」", icon: "🦈", rarity: "激レア", weight: 400 },
  { id: "🧛", type: "avatar", name: "アバター「吸血鬼」", icon: "🧛", rarity: "激レア", weight: 400 },
  { id: "🧙", type: "avatar", name: "アバター「大魔法使い」", icon: "🧙", rarity: "激レア", weight: 400 },
  { id: "🥷", type: "avatar", name: "アバター「マスター忍者」", icon: "🥷", rarity: "激レア", weight: 400 },
  { id: "🐯", type: "avatar", name: "アバター「ホワイトタイガー」", icon: "🐯", rarity: "激レア", weight: 400 },
  { id: "🐺", type: "avatar", name: "アバター「フェンリル」", icon: "🐺", rarity: "激レア", weight: 400 },
  ...
  { id: "🐶", type: "avatar", name: "アバター「犬」", icon: "🐶", rarity: "レア", weight: 1000 },
  { id: "🐱", type: "avatar", name: "アバター「猫」", icon: "🐱", rarity: "レア", weight: 1000 },
  { id: "🦊", type: "avatar", name: "アバター「キツネ」", icon: "🦊", rarity: "レア", weight: 1000 },
  { id: "🐻", type: "avatar", name: "アバター「クマ」", icon: "🐻", rarity: "レア", weight: 1000 },
  { id: "🐼", type: "avatar", name: "アバター「パンダ」", icon: "🐼", rarity: "レア", weight: 1000 },
  { id: "🦁", type: "avatar", name: "アバター「ライオン」", icon: "🦁", rarity: "レア", weight: 1000 },
  { id: "🐸", type: "avatar", name: "アバター「カエル」", icon: "🐸", rarity: "レア", weight: 1000 },
  { id: "🦉", type: "avatar", name: "アバター「フクロウ」", icon: "🦉", rarity: "レア", weight: 1000 },
  { id: "👻", type: "avatar", name: "アバター「おばけ」", icon: "👻", rarity: "レア", weight: 1000 },
