"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[358],{5002:function(e,t,n){n.d(t,{IO:function(){return sc},JU:function(){return iP},PL:function(){return sR},QT:function(){return sb},Xo:function(){return sg},ad:function(){return i$},ar:function(){return sf},b9:function(){return sw},cf:function(){return sL},hJ:function(){return iO},i3:function(){return sP},pl:function(){return sx}});var r,i,s,a,o=n(9279),l=n(2680),u=n(9053),h=n(3943),c=n(6552),d=n(4575);n(357);var f=n(6300).Buffer;let m="@firebase/firestore";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function sI(e,t,n){return e?n&&(n.merge||n.mergeFields)?e.toFirestore(t,n):e.toFirestore(t):t}class sC extends sT{constructor(e){super(),this.firestore=e}convertBytes(e){return new iK(e)}convertReference(e){let t=this.convertDocumentKey(e,this.firestore._databaseId);return new iM(this.firestore,null,t)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class sA{constructor(e,t){this.hasPendingWrites=e,this.fromCache=t}isEqual(e){return this.hasPendingWrites===e.hasPendingWrites&&this.fromCache===e.fromCache}}class sS extends ss{constructor(e,t,n,r,i,s){super(e,t,n,r,s),this._firestore=e,this._firestoreImpl=e,this.metadata=i}exists(){return super.exists()}data(e={}){if(this._document){if(this._converter){let t=new sN(this._firestore,this._userDataWriter,this._key,this._document,this.metadata,null);return this._converter.fromFirestore(t,e)}return this._userDataWriter.convertValue(this._document.data.value,e.serverTimestamps)}}get(e,t={}){if(this._document){let n=this._document.data.field(so("DocumentSnapshot.get",e));if(null!==n)return this._userDataWriter.convertValue(n,t.serverTimestamps)}}}class sN extends sS{data(e={}){return super.data(e)}}class sk{constructor(e,t,n,r){this._firestore=e,this._userDataWriter=t,this._snapshot=r,this.metadata=new sA(r.hasPendingWrites,r.fromCache),this.query=n}get docs(){let e=[];return this.forEach(t=>e.push(t)),e}get size(){return this._snapshot.docs.size}get empty(){return 0===this.size}forEach(e,t){this._snapshot.docs.forEach(n=>{e.call(t,new sN(this._firestore,this._userDataWriter,n.key,n,new sA(this._snapshot.mutatedKeys.has(n.key),this._snapshot.fromCache),this.query.converter))})}docChanges(e={}){let t=!!e.includeMetadataChanges;if(t&&this._snapshot.excludesMetadataChanges)throw new A(C.INVALID_ARGUMENT,"To include metadata changes with your document changes, you must also pass { includeMetadataChanges:true } to onSnapshot().");return this._cachedChanges&&this._cachedChangesIncludeMetadataChanges===t||(this._cachedChanges=function(e,t){if(e._snapshot.oldDocs.isEmpty()){let t=0;return e._snapshot.docChanges.map(n=>{let r=new sN(e._firestore,e._userDataWriter,n.doc.key,n.doc,new sA(e._snapshot.mutatedKeys.has(n.doc.key),e._snapshot.fromCache),e.query.converter);return n.doc,{type:"added",doc:r,oldIndex:-1,newIndex:t++}})}{let n=e._snapshot.oldDocs;return e._snapshot.docChanges.filter(e=>t||3!==e.type).map(t=>{let r=new sN(e._firestore,e._userDataWriter,t.doc.key,t.doc,new sA(e._snapshot.mutatedKeys.has(t.doc.key),e._snapshot.fromCache),e.query.converter),i=-1,s=-1;return 0!==t.type&&(i=n.indexOf(t.doc.key),n=n.delete(t.doc.key)),1!==t.type&&(s=(n=n.add(t.doc)).indexOf(t.doc.key)),{type:function(e){switch(e){case 0:return"added";case 2:case 3:return"modified";case 1:return"removed";default:return I()}}(t.type),doc:r,oldIndex:i,newIndex:s}})}}(this,t),this._cachedChangesIncludeMetadataChanges=t),this._cachedChanges}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function sb(e){e=iR(e,iM);let t=iR(e.firestore,iB);return(function(e,t,n={}){let r=new S;return e.asyncQueue.enqueueAndForget(async()=>(function(e,t,n,r,i){let s=new ig({next:o=>{s.Za(),t.enqueueAndForget(()=>rz(e,a));let l=o.docs.has(n);!l&&o.fromCache?i.reject(new A(C.UNAVAILABLE,"Failed to get document because the client is offline.")):l&&o.fromCache&&r&&"server"===r.source?i.reject(new A(C.UNAVAILABLE,'Failed to get document from server. (However, this document does exist in the local cache. Run again without setting source to "server" to retrieve the cached document.)')):i.resolve(o)},error:e=>i.reject(e)}),a=new rj(e6(n.path),s,{includeMetadataChanges:!0,_a:!0});return r$(e,a)})(await iC(e),e.asyncQueue,t,n,r)),r.promise})(iz(t),e._key).then(n=>sV(t,e,n))}class sD extends sT{constructor(e){super(),this.firestore=e}convertBytes(e){return new iK(e)}convertReference(e){let t=this.convertDocumentKey(e,this.firestore._databaseId);return new iM(this.firestore,null,t)}}function sR(e){e=iR(e,iV);let t=iR(e.firestore,iB),n=iz(t),r=new sD(t);return sl(e._query),(function(e,t,n={}){let r=new S;return e.asyncQueue.enqueueAndForget(async()=>(function(e,t,n,r,i){let s=new ig({next:n=>{s.Za(),t.enqueueAndForget(()=>rz(e,a)),n.fromCache&&"server"===r.source?i.reject(new A(C.UNAVAILABLE,'Failed to get documents from server. (However, these documents may exist in the local cache. Run again without setting source to "server" to retrieve the cached documents.)')):i.resolve(n)},error:e=>i.reject(e)}),a=new rj(n,s,{includeMetadataChanges:!0,_a:!0});return r$(e,a)})(await iC(e),e.asyncQueue,t,n,r)),r.promise})(n,e._query).then(n=>new sk(t,r,e,n))}function sx(e,t,n){var r;e=iR(e,iM);let i=iR(e.firestore,iB),s=sI(e.converter,t,n);return r=[i2(i1(i),"setDoc",e._key,s,null!==e.converter,n).toMutation(e._key,tL.none())],function(e,t){let n=new S;return e.asyncQueue.enqueueAndForget(async()=>r8(await iI(e).then(e=>e.syncEngine),t,n)),n.promise}(iz(i),r)}function sL(e,...t){var n,r,i;let s,a,o;e=(0,h.m9)(e);let l={includeMetadataChanges:!1,source:"default"},u=0;"object"!=typeof t[0]||iq(t[u])||(l=t[u],u++);let c={includeMetadataChanges:l.includeMetadataChanges,source:l.source};if(iq(t[u])){let e=t[u];t[u]=null===(n=e.next)||void 0===n?void 0:n.bind(e),t[u+1]=null===(r=e.error)||void 0===r?void 0:r.bind(e),t[u+2]=null===(i=e.complete)||void 0===i?void 0:i.bind(e)}if(e instanceof iM)a=iR(e.firestore,iB),o=e6(e._key.path),s={next:n=>{t[u]&&t[u](sV(a,e,n))},error:t[u+1],complete:t[u+2]};else{let n=iR(e,iV);a=iR(n.firestore,iB),o=n._query;let r=new sD(a);s={next:e=>{t[u]&&t[u](new sk(a,r,n,e))},error:t[u+1],complete:t[u+2]},sl(e._query)}return function(e,t,n,r){let i=new ig(r),s=new rj(t,i,n);return e.asyncQueue.enqueueAndForget(async()=>r$(await iC(e),s)),()=>{i.Za(),e.asyncQueue.enqueueAndForget(async()=>rz(await iC(e),s))}}(iz(a),o,c,s)}function sV(e,t,n){let r=n.docs.get(t._key),i=new sD(e);return new sS(e,i,t._key,r,new sA(n.hasPendingWrites,n.fromCache),t.converter)}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class sO extends class{constructor(e,t){this._firestore=e,this._transaction=t,this._dataReader=i1(e)}get(e){let t=sF(e,this._firestore),n=new sC(this._firestore);return this._transaction.lookup([t._key]).then(e=>{if(!e||1!==e.length)return I();let r=e[0];if(r.isFoundDocument())return new ss(this._firestore,n,r.key,r,t.converter);if(r.isNoDocument())return new ss(this._firestore,n,t._key,null,t.converter);throw I()})}set(e,t,n){let r=sF(e,this._firestore),i=sI(r.converter,t,n),s=i2(this._dataReader,"Transaction.set",r._key,i,null!==r.converter,n);return this._transaction.set(r._key,s),this}update(e,t,n,...r){let i;let s=sF(e,this._firestore);return i="string"==typeof(t=(0,h.m9)(t))||t instanceof iQ?i9(this._dataReader,"Transaction.update",s._key,t,n,r):i4(this._dataReader,"Transaction.update",s._key,t),this._transaction.update(s._key,i),this}delete(e){let t=sF(e,this._firestore);return this._transaction.delete(t._key),this}}{constructor(e,t){super(e,t),this._firestore=e}get(e){let t=sF(e,this._firestore),n=new sD(this._firestore);return super.get(e).then(e=>new sS(this._firestore,n,t._key,e._document,new sA(!1,!1),t.converter))}}function sP(e,t,n){e=iR(e,iB);let r=Object.assign(Object.assign({},sM),n);return!function(e){if(e.maxAttempts<1)throw new A(C.INVALID_ARGUMENT,"Max attempts must be at least 1")}(r),function(e,t,n){let r=new S;return e.asyncQueue.enqueueAndForget(async()=>{let i=await iI(e).then(e=>e.datastore);new iw(e.asyncQueue,i,n,t,r).au()}),r.promise}(iz(e),n=>t(new sO(e,n)),r)}new WeakMap,function(e=!0){g=o.Jn,(0,o.Xd)(new l.wA("firestore",(t,{instanceIdentifier:n,options:r})=>{let i=t.getProvider("app").getImmediate(),s=new iB(new D(t.getProvider("auth-internal")),new V(t.getProvider("app-check-internal")),function(e,t){if(!Object.prototype.hasOwnProperty.apply(e.options,["projectId"]))throw new A(C.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new ev(e.options.projectId,t)}(i,n),i);return r=Object.assign({useFetchStreams:e},r),s._setSettings(r),s},"PUBLIC").setMultipleInstances(!0)),(0,o.KN)(m,"4.7.3",void 0),(0,o.KN)(m,"4.7.3","esm2017")}()}}]);