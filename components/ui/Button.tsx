...
export function Button({
  ...
  const variants = {
    primary: "bg-[linear-gradient(180deg,#93c5fd_0%,#3b82f6_50%,#1d4ed8_100%)] text-white hover:brightness-110 border-b-[8px] border-blue-900 active:border-b-0 active:translate-y-[8px] shadow-[0_14px_24px_rgba(29,78,216,0.5),inset_0_4px_0_rgba(255,255,255,0.55),inset_0_-6px_10px_rgba(30,58,138,0.4)] active:shadow-none text-outline-dark",
    secondary: "bg-[linear-gradient(180deg,#6ee7b7_0%,#10b981_50%,#047857_100%)] text-white hover:brightness-110 border-b-[8px] border-emerald-900 active:border-b-0 active:translate-y-[8px] shadow-[0_14px_24px_rgba(5,150,105,0.45),inset_0_4px_0_rgba(255,255,255,0.55),inset_0_-6px_10px_rgba(6,78,59,0.4)] active:shadow-none drop-shadow-game-text",
    danger: "bg-[linear-gradient(180deg,#fca5a5_0%,#ef4444_50%,#b91c1c_100%)] text-white hover:brightness-110 border-b-[8px] border-red-900 active:border-b-0 active:translate-y-[8px] shadow-[0_14px_24px_rgba(220,38,38,0.45),inset_0_4px_0_rgba(255,255,255,0.55),inset_0_-6px_10px_rgba(69,10,10,0.4)] active:shadow-none drop-shadow-game-text",
    fun: "bg-[linear-gradient(180deg,#fef08a_0%,#f59e0b_50%,#b45309_100%)] text-white hover:brightness-110 border-b-[8px] border-orange-900 active:border-b-0 active:translate-y-[8px] shadow-[0_14px_24px_rgba(234,88,12,0.45),inset_0_4px_0_rgba(255,255,255,0.6),inset_0_-6px_10px_rgba(69,26,3,0.4)] active:shadow-none drop-shadow-game-text",
    premium: "bg-[linear-gradient(180deg,#fef3c7_0%,#fbbf24_30%,#d97706_70%,#78350f_100%)] border-yellow-100 text-white hover:brightness-110 border-b-[8px] border-yellow-950 active:border-b-0 active:translate-y-[8px] shadow-[0_16px_28px_rgba(0,0,0,0.45),inset_0_4px_10px_rgba(255,255,255,0.7),inset_0_-8px_12px_rgba(0,0,0,0.35)] active:shadow-none drop-shadow-game-text",
    outline: "bg-[linear-gradient(180deg,#ffffff_0%,#f8fafc_60%,#eef2f7_100%)] text-slate-800 border-b-[6px] border-slate-300 hover:brightness-95 active:translate-y-[6px] shadow-[0_10px_18px_rgba(15,23,42,0.1),inset_0_4px_0_rgba(255,255,255,1),inset_0_-4px_6px_rgba(148,163,184,0.25)] active:shadow-none active:border-b-0",
